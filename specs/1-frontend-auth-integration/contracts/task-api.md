...
## Overview
This document defines the API contract between the frontend application and the backend task management service. All endpoints require JWT authentication in the form of an Authorization header.
